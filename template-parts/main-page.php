    ...
    <!--Banner Area Start-->
    <div class="section banner-sec" id="banner-sec">
    ...
    <!--Brand Area Start-->
    <div class="section brand-sec" id="brand-sec">
        <div class="container">
            <div class="row">
    ...
    <!--Team Area Start-->
    <div class="section team-sec" id="team-sec">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-5">
